...
faker = Faker()
otime = datetime.datetime(2020, 1, 1)

while otime.year < 2021:
    directory = 'access_logs_2020/' + str(otime.month) + '/'
    outFileName = 'access_log_' + str(otime.day) + '.log'
    ...
    while (flag):
        ...
        flag = False if (otime.hour == 23 and otime.minute >= 55) else True
        print(str(otime.hour) + str(otime.minute))
        print(str(flag))
        if args.sleep:
